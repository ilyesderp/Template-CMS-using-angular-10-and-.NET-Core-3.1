		...
		isotopeGalleryPagination: {
			...
			initIsotope: function() {
				...
				if ( $(".filters-container").length ) {
					...
					// 		debugger;
					// 		Onyx.log("data-filter => " + $(this).attr("data-filter"));
			 ...
			 * Chage page function
			 */
			goToPage: function(n, itemSelector , currentPage , currentFilter , filterAtribute , pageAtribute ) {
				currentPage = n;
			 ...
			 * Begin pagination steps
			 */
			setPagination: function(itemSelector , itemsPerPage , currentNumberPages , currentFilter , filterAtribute , pageAtribute , pagerClass , currentPage ) {
